function calculateHiddenMMR() {
    ...
    // Set the progress bar width and color based on rank
    let progressBar = document.getElementById("progressBar");
    let progress = (hiddenMMR - 1000) / 3900 * 100; // Percentage based on the Copper 5 to Champion range
    progressBar.style.width = `${Math.min(progress, 100)}%`;

    // Change progress bar color based on rank
